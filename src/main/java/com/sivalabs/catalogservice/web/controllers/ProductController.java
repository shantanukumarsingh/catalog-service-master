...
public class ProductController {
    ...
    @GetMapping("byname/{strProductName}")
    public List<Product> findProductByName(@PathVariable String strProductName) {
    	log.info("Inside ProductController : findProductByName :" + strProductName);
    	  return productService.findProductByName(strProductName);
    } 
}
